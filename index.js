			...
			case 'mapa': 
				...
				case 'figurinha':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply(`opam ${prefix}fig é pra fazer figurinha com imagem e gif pow n\não sabe como fazer figurinhas? rlx pow eu te explico n\➞Mande uma imagem ou gif com a legenda !fig n\➞ta aqui os outros comandos para fazer figurinhas: n\➞!sticker !stiker !figurinha n\➞obs: pra fazer figurinhas com video e só diminuir a duração do vídeo pra 5 segundos se não for é só diminuir a duração pra 3 segundos n\➞para saber mais sobre o bot envie o comando !help ou !menu n\➞se não tiver conseguindo usar o bot mande mensagem nesse número que irei te ajudar wa.me/19203255902 n\➞espero que goste do bot❤️`)
					}
					break
				case 'gtts':	
				case 'tts':

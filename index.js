...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '❬⏳❭ PERA AE TÔ FAZENDO SE NÃO FOR TENTE NOVAMENTE ❬⏳❭',
				success: '️❬ ✔ ❭ PRONTINHO 🖤',
				error: {
					stick: 'deu erro mn',
					Iv: 'link ta inválido'
			...
			const ownerNumber = ["557598773508@s.whatsapp.net"] 
...
case 'lofi':
                ...
                case 'reportarbug':
                    ...
                    client.sendMessage('55759877350@s.whatsapp.net', options, text, {quoted: mek})
			...
			tels = body.slice(6)
             ...
             break
                ...
                case 'gado':
                    ...
                    hasil = `PORCERTAGEM : *${body.slice(1)}*\n\nVOCÊ TEM: : *${random}%* DE  CHANCE NAMORAR ESSE ANO😳`
                    reply(hasil)
                    break
                case 'corno':
                    client.updatePresence(from, Presence.composing) 
				...
				case 'touka':
					...
					client.sendMessage(from, nye, image, { caption: 'touka!!', quoted: mek })
					await limitAdd(sender) 
					break 
				case 'akira':
					reply(mess.wait)
        ...
        case 'delete':
          ...
          contextInfo: { mentionedJid: [from] }
           ...
           frhan.sendMessage(from, options, text, { quoted: mek } )
				break
                case 'logo3d':
              	    if (args.length < 1) return reply('onde está o texto mn?')
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'O texto é muito longo, no máximo 10 letras', text, {quoted: mek})
            ...
            case 'criador':
                  ...
                  client.sendMessage(from, {displayname: "sad adm", vcard: vcard}, MessageType.contact, { quoted: mek})

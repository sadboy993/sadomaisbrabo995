...
case 'lofi':
                ...
                case 'pokemon':
					...
					break
				case 'cantada':
					cantada = body.slice(1)
					const can =['gata se você fosse um peido eu nunca te soltaria','achei ofensivo sua roupa, tira','gata me chama de estados unidos e me U.S.A','o crime so compensa se for pra roubar uns beijos seu','que perfume e esse que você passa e fica com cheiro de amor da minha vida?','meu nome e muito grande acho melhor vc me chamar de amor','nem precisa acender a luz pra ficar claro que eu quero você','vi seu nome na lata de margarina\n que?\n sim tava escrito delícia','gata fiquei sabendo que bife não gosta de você\n ué pq?\n sei lá pow vai la perguntar pra ele','me chama de asma que eu te deixo sem ar','gata vai pegar ônibus?\n porque você ta no ponto sua linda','gata não sou quebra cabeça mas me encaixo direitinho em você','Gato, me chama de pérola e vem dormir de conchinha comigo','Não sou garota do tempo, mas eu vi a previsão para hoje e o clima está perfeito para nós','Tô aqui comentando suas fotos com os pés, porque com as mãos tô te aplaudindo de tão gata','Vontade de fazer aquilo que começa com S: Ser o motivo da sua felicidade']
					const by = hob[Math.floor(Math.random() * hob.length)]
					client.sendMessage(from, 'hum : *'+;-;+'*\n\nsua cantada ai mn ksks : '+ by, text, { quoted: mek })
                          break
case 'idiomas':
		if (args.length < 1) return reply ('Ta ai mn\n    af    Afrikaans
  'sq': 'Albanian',
  'ar': 'Arabic',
  'hy': 'Armenian',
  'ca': 'Catalan',
